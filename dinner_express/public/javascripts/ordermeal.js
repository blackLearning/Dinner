...
(function(window, $){
    $(function(){
        ...
        //  加班餐服务协议
        $('#workService').click(function(){
            alertInfo.show($('#workServiceContent').text());
        });
        // 点餐条件的判断
        $('#submit').click(function() {
            ...
            $.post('/user/order', {food: food, date: new Date()}, function(results) {
                if(results.success === true) {
                    alertInfo.show('点餐成功,请耐心等待吧！'); 
                } else if( results.success === 'repeat'){
                    // 每天只能点一次
